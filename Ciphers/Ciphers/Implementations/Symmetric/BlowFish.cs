...
{
    private static readonly uint[] PI =
    {
    ...
    private static readonly uint[,] SUBS =
    {
        {
    ...
    private readonly uint[] pi;
    private readonly uint[,] subs;

    public BlowFish(string key1)
    {
        var key = Encoding.Unicode.GetBytes(key1);
    ...
    public string Encrypt(string text)
    {
        ...
        var stringInBytes = Encoding.Unicode.GetBytes(text);
        uint xl, xr;
        var length = stringInBytes.Length;
        var data = stringInBytes;
